...
// File paths
const UPDATES_PATH = path.join(__dirname, 'kb_updates_cumulative.json');
const CHANGELOG_PATH = path.join(__dirname, 'kb_changelog.json');
const MERGED_PATH = path.join(__dirname, 'knowledge_base_merged_v2.json');
